...
const Banner = () => {
  return (
    <section className="banner-area banner-bg" style={{paddingBottom: "9rem"}}>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            <div className="banner-content text-center">
              ...
              <h2 className="title">
               <span>WealthVerse</span> Your Gateway to Wealth and Opportunities
              </h2>
            </div>
        ...
        <div className="row justify-content-center" style={{marginTop : "10rem"}}>
          <div className="col-xl-10">
            <div className="banner-countdown-wrap text-center">
              <h2 className="title">Registration Will Start In..</h2>
